            ...
            >
              ...
              <div className="relative aspect-video bg-[#0B0D14] flex flex-col items-center justify-center text-text-primary px-6 text-center space-y-4">
                ...
                <div className="flex items-center gap-1.5 h-8">
                  {[...Array(6)].map((_, i) => (
                    <motion.div
                      key={i}
                      className="w-1 bg-text-primary rounded-full"
              ...
              <div className="bg-surface p-4 flex items-center justify-between text-text-primary border-t border-border-divider">
                <button
                  ...
                  className="px-4 py-1.5 bg-text-primary hover:bg-text-primary/95 text-bg-base text-xs font-bold rounded cursor-pointer transition-colors duration-200"
                >
                ...
                <div className="flex-1 mx-4 h-1 bg-bg-base rounded-full relative overflow-hidden">
                  <motion.div
                    className="absolute top-0 left-0 bottom-0 bg-text-primary"
                ...
                {/* Volume icon */}
                <Volume2 size={16} className="text-text-secondary/60 hover:text-text-primary cursor-pointer" />
              </div>
            </motion.div>
          </>
        )}
